  ...
  return (
    <div className="carousel w-full">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute text-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-top-left">
          <h1>Change ta manière de t'entraîner</h1>
        </div>
        <div className="absolute text-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-bottom-left">
          <p>Rejoins aujourd'hui une communauté de sportifs</p>
          <br></br>
          <p>au plus proche de toi</p>
          <br></br>
          <p>dès maintenant</p>
        </div>
      </div>
